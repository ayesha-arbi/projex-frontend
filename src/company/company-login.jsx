  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (msg.toLowerCase().includes("password")) {
        ...
        setErrors({ email: "No account found with this email.(please check your email and verify, if you just registered)" });
    ...
    <>
      ...
      <div style={{ minHeight: "100vh", display: "flex", background: C.cream }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: "1.05rem", lineHeight: 1.6, color: "rgba(255,255,255,0.7)", fontFamily: fonts.body, maxWidth: 440 }}>
        ...
        <div style={{ flex: 1, overflowY: "auto", display: "flex", alignItems: "center", justifyContent: "center", padding: "48px 40px" }}>
          <div style={{ width: "100%", minWidth: 520, animation: "slideIn 0.35s ease both" }}>
            ...
            <p style={{ textAlign: "center", fontSize: "0.75rem", color: C.muted2, marginTop: 20, lineHeight: 1.6, fontFamily: fonts.body }}>
              Having trouble?{" "}
              <a href="mailto:support@origin.com" style={{ color: C.navy, fontWeight: 600, textDecoration: "none" }}>Contact support</a>
            </p>
          </div>
        </div>
